...
public class MetodosGenerales {
                ...
                switch (elementoTemp.getName()) {
                    ...
                    case "Titular":
                        ...
                        for ( int k = 0; k < listaHijosTitular.size(); k++ ){
                            ...
                            }else datosXML.getListaComponentes().add(new ComponenteFormulario(hijoDeTitular.getName(), hijoDeTitular.getText()));
                        }   break;
                    default:
            ...
            for ( int i = 0; i < list.size(); i++ ){
                ...
                if (elementoTemp.getName().equals("Registral")){
                    ...
                    for ( int j = 0; j < listaHijosTitular.size(); j++ ){
                        ...
                        }else listaTempTitular.add(new ComponenteFormulario(hijoDeTitular.getName(), hijoDeTitular.getText()));
                    }
    ...
    private static Documento convertirDocumento(String nombreDocumento, String tipoDocumento){
        ...
        switch (tipoDocumento){
            case "IRPF": fichero = new File("/home/BPO/ConvirtiendoWS/IRPF/".concat(nombreDocumento));break; 
            case "Nomina": fichero = new File("/home/BPO/ConvirtiendoWS/Nomina/".concat(nombreDocumento));break; 
            case "Nota Simple": fichero = new File("/home/BPO/ConvirtiendoWS/Nota Simple/".concat(nombreDocumento));break; 
            case "Recibo": fichero = new File("/home/BPO/ConvirtiendoWS/Recibo/".concat(nombreDocumento));break; 
            case "Tasacion": fichero = new File("/home/BPO/ConvirtiendoWS/Tasacion/".concat(nombreDocumento));break; 
            case "Vida Laboral": fichero = new File("/home/BPO/ConvirtiendoWS/Vida Laboral/".concat(nombreDocumento));break; 
            case "Nota Simple OCR": fichero = new File("/home/BPO/ConvirtiendoWS/NotaSimpleOCR/".concat(nombreDocumento));break; 
        }
        ...
        for (DatosEnvio datosEnvio : arrayOfDatosEnvio.getDatosEnvio()) {
            ...
            for (Documento documento : documentos) {
                 //if(!existeArchivo(channelSftpTech, documento.getFileName().getValue())){
                    ...
                    else nombreDocumento = nombreYExt[0].concat("___").concat(String.valueOf(datosEnvio.getIDSolicitud().getValue())).concat(".").concat(nombreYExt[1]);
                    ...
                    else TimerTaskSchedule.generarTraza(channelSftpTech, directorio, documento.getFileName().getValue(), "Descargado de GrupoBC",String.valueOf(datosEnvio.getIDSolicitud().getValue()), "Descargados");
                //}
            }
        }
        }catch (IOException e){
    ...
    */
    ...
    public static ArrayList<String> getAddressList(Integer typeOfAddress){
        ...
        else filePath = "/home/adiaz/bpo/Servicio/conf/address_afternoon.dat"; //filePath = System.getProperty("user.dir").concat("\\conf\\address_afternoon.dat");
